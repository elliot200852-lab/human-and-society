      ...
      weeks: [
        {
          week: '第三週',
          date: '2026-09-04',
          title: '呂讀台灣｜蔣渭水不畏強權成台灣第一反',
          link: 'https://www.youtube.com/watch?v=sG-Xc5erE6s',
          linkLabel: '影片連結',
          // done：這一週已經發生過，內容以現場為準。
          // Doc（週五活動 SSOT）上原本排的是「進步時代－臺中文協百年的美術力 紀錄片」，
          // 當天臨時改看《呂讀台灣》蔣渭水那一集（David 2026-09-05 指示：以實際為準，
          // 原本那部直接移除）。hs-friday-update 對帳時**不要**把這張卡片改回 Doc 的排程，
          // 只在回報裡提醒 David 去更新 Doc。判準見 hs-friday-update SKILL「已發生的週次」節。
          done: true,
          notes: {
            label: '對話紀錄',
            file: '2026-09-04_第二次週五聚會對話紀錄.html',
          },
        },
        {
          week: '第二週',
          ...
          // 當週對話紀錄（公開版）——檔案在 Drive「網站素材 ▸ 05_週五活動」，
          // file 欄與 Drive 上的檔名逐字相同，網址由 urlFor(cat, notes) 組出。
          notes: {
            label: '對話紀錄',
            file: '2026-08-28_第一次週五聚會對話紀錄.html',
          },
        },
        {
          week: '第一週',
    ...
    items: [
      {
        ...
        date: '2026-09-04',
        size: '',
        desc: '秋季第二場週五聚會的對話紀錄：先一起看《呂讀台灣》講蔣渭水的那一集，再從影片走進對話——路線之爭與分裂如何被製造、出身如何決定一個人看見什麼（當醫生的蔣渭水與大家族出身的蔡培火）、宜蘭的童乩與鸞堂，以及那個時代的女性（蔡阿信、陳甜、辜顏碧霞）。文末附影片連結與「核心人物與歷史名詞速查表」。下一場主題定為那個時代的女性。',
        file: '2026-09-04_第二次週五聚會對話紀錄.html',
      },
      {
        title: '第一次週五聚會．對話紀錄',
        date: '2026-08-28',
        size: '',
        desc: '秋季第一場週五聚會的對話紀錄：1919 年第一所華德福學校與 1920 年前後台灣文化啟蒙的對照、把台灣接進各年段課程的接點、日治時期公共衛生如何改寫台灣人的生死觀，以及中元、好兄弟與台灣的鬼故事。下一場主題定為蔣渭水。',
        file: '2026-08-28_第一次週五聚會對話紀錄.html',
      },
    ],
  },
