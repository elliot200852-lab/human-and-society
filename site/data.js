    ...
    items: [
      {
        ...
        date: '2026-09-04',
        size: '',
        desc: '秋季第二場週五聚會的對話紀錄：先一起看《呂讀台灣》講蔣渭水的那一集，再從影片走進對話——路線之爭與分裂如何被製造、出身如何決定一個人看見什麼（當醫生的蔣渭水與大家族出身的蔡培火）、宜蘭的童乩與鸞堂，以及那個時代的女性（蔡阿信、陳甜、辜嚴倬雲）。文末附影片連結與「核心人物與歷史名詞速查表」。下一場主題定為那個時代的女性。',
        file: '2026-09-04_第二次週五聚會對話紀錄.html',
      },
      {
        title: '第一次週五聚會．對話紀錄',
